...
//will loop through result
//find the first object that says "WIN" based on a callback
const record = [
...
//     let foundItem = record.find(element => {
...
// function isWin() {
//     return resultAndTheYear.result === "W"
// }
// superbowlWin(record)

// function superbowlWin(record) {
//     let foundItem = record.forEach(isWin)
//     return foundItem
// }
...
// !!condition? result.year: undefined
